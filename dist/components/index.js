import { w as widget, c as charmaAPI } from './charma-delivery2.js';
export { c as charmaAPI, w as widget } from './charma-delivery2.js';
import { _ as _createClass, a as _classCallCheck, i as instance } from './i18next.js';
export { getAssetPath, setAssetPath, setNonce, setPlatformOptions } from '@stencil/core/internal/client';
export { CharmaCard, defineCustomElement as defineCustomElementCharmaCard } from './charma-card.js';
export { CharmaConfirmation, defineCustomElement as defineCustomElementCharmaConfirmation } from './charma-confirmation.js';
export { CharmaDelivery, defineCustomElement as defineCustomElementCharmaDelivery } from './charma-delivery.js';
export { CharmaDropdown, defineCustomElement as defineCustomElementCharmaDropdown } from './charma-dropdown.js';
export { CharmaGiftingButton, defineCustomElement as defineCustomElementCharmaGiftingButton } from './charma-gifting-button.js';
export { CharmaInput, defineCustomElement as defineCustomElementCharmaInput } from './charma-input.js';
export { CharmaOrderPlaced, defineCustomElement as defineCustomElementCharmaOrderPlaced } from './charma-order-placed.js';
export { CharmaPayment, defineCustomElement as defineCustomElementCharmaPayment } from './charma-payment.js';
export { CharmaProducts, defineCustomElement as defineCustomElementCharmaProducts } from './charma-products.js';
export { CharmaRadioGroup, defineCustomElement as defineCustomElementCharmaRadioGroup } from './charma-radio-group.js';
export { CharmaTextarea, defineCustomElement as defineCustomElementCharmaTextarea } from './charma-textarea.js';
export { CharmaWidget, defineCustomElement as defineCustomElementCharmaWidget } from './charma-widget.js';
