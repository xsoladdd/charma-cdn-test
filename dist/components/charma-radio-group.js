...
const CharmaRadioGroup$1 = /*@__PURE__*/ proxyCustomElement(class CharmaRadioGroup extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return charmaRadioGroupCss; }
}, [1, "charma-radio-group", {
    "label": [1],
    "name": [1],
    "options": [16],
    "selected": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["charma-radio-group"];
  components.forEach(tagName => { switch (tagName) {
    case "charma-radio-group":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CharmaRadioGroup$1);
      }
      break;
  } });
}

const CharmaRadioGroup = CharmaRadioGroup$1;
const defineCustomElement = defineCustomElement$1;

export { CharmaRadioGroup, defineCustomElement };
